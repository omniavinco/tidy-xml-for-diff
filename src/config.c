...
static const TidyOptionImpl option_defs[] =
{
  ...
  { TidyIndentContent,           PP, "indent",                      IN, TidyAutoState,   ParseAutoBool,     autoBoolPicks   },
  ...
  { TidyXmlTags,                 MU, "input-xml",                   BL, yes,             ParseBool,         boolPicks       },
  { TidyXmlOut,                  MU, "output-xml",                  BL, yes,             ParseBool,         boolPicks       },
  ...
  { TidyQuoteMarks,              MU, "quote-marks",                 BL, yes,             ParseBool,         boolPicks       },
  ...
  { TidyIndentAttributes,        PP, "indent-attributes",           BL, yes,             ParseBool,         boolPicks       },
  ...
  { TidyMark,                    MS, "tidy-mark",                   BL, no,              ParseBool,         boolPicks       },
  { TidyEmacs,                   MS, "gnu-emacs",                   BL, no,              ParseBool,         boolPicks       },
  { TidyEmacsFile,               MS, "gnu-emacs-file",              ST, 0,               ParseString,       NULL            },
  { TidyLiteralAttribs,          MU, "literal-attributes",          BL, yes,             ParseBool,         boolPicks       },
  ...
  { TidySortAttributes,          PP, "sort-attributes",             IN, TidySortAttrAlpha,ParseSorter,       sorterPicks     },
  { TidyForDiff,                 PP, "for-diff",                    BL, yes,              ParseBool,         boolPicks       },
